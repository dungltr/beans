...
public class MaterializedWorkflow1 {
	...
	public HashMap<String,List<WorkflowNode>> bestPlans;
        /*Dung edit begin*/
        public HashMap<String,List<WorkflowNode>> ParetoPlans;
        /*Dung edit end*/
	...
	public MaterializedWorkflow1(String name, String directory) {
		...
		bestPlans = new HashMap<String, List<WorkflowNode>>();
                /*Dung edit begin*/
                ParetoPlans = new HashMap<String, List<WorkflowNode>>();
                /*Dung edit end*/
		optimalCost=0.0;
		count=0;
	...
	public void setBestPlan(String target, List<WorkflowNode> plan){
        ...
        /*Dung edit begin*/
        public void addParetorPlan(String target, List<WorkflowNode> plan){
		logger.info("Target: "+target);
		logger.info("Pareto plan: ");
		for(WorkflowNode w : plan)
			logger.info(w.toStringNorecursive());
		ParetoPlans.put(target, plan);
	}
	/*Dung edit end*/
